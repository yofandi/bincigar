<div class="col-lg-12">
  <div class="card">
    <div class="card-body">
      <strong><i class="fa fa-home"></i> / Dashboard / Proses Produksi / Edit Drying / <?php echo $datas['id'] ?></strong>
    </div>
  </div>
</div>
...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header bg-success text-light">
      <strong><i class="fa fa-edit"></i> Edit Proses Frezer</strong>
    </div>
    <div class="card-body">
      
        <form method="post" action="<?php echo base_url('Proses_produksi/update_frezer/'.$datas['id']) ?>">
        <div class="col-lg-12">
        ...
        <div class="col-lg-6">
          <?php $fumigasi = $this->db->order_by('id','DESC')->get('fumigasi')->row_array(); ?>
