<div class="col-lg-12">
  <div class="card">
    <div class="card-body">
      <strong><i class="fa fa-home"></i> / Dashboard / Proses Produksi / Edit wrapping / <?php echo $datas['id'] ?></strong>
    </div>
  </div>
</div>
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
        <form method="post" action="<?php echo base_url('Proses_produksi/update_wrapping/'.$datas['id']) ?>">
        <div class="col-lg-12">
