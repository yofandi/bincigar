<style>
  ...
  @media print {
    #show {text-align: center;}
    @page {size: A4 landspace;}
  }
</style>
<div class="col-lg-12">
  <div class="card">
    <div class="card-body">
      <strong><i class="fa fa-home"></i> / Dashboard / Proses Produksi / Proses Fumigasi</strong>
    </div>
  </div>
</div>
<?php 
...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header bg-danger text-light">
      <strong><i class="fa fa-gear"></i> Proses Fumigasi | Hari Ini : <?php echo date('Y-m-d') ?></strong>
    ...
    <div class="card-body" id="kk">
      ...
      <center>
        <b>LAPORAN PROSES PRODUKSI (Fumigasi) HARI INI</b>
        <br>Tanggal : <?php echo date('d').' '.$bulan[date('m')].' '.date('Y'); ?></center>
      </div>
      <div class="action">
      <table class="table table-hover" id="table_ku">
        ...
        <tbody>
          <?php $no=1;foreach ($Fumigasi as $key): ?>
            <tr>
              <td><?php echo $no ?></td>
              ...
              <td class="action">
                <a class="btn btn-warning btn-sm" href="<?php echo base_url('Proses_produksi/edit_fumigasi/'.$key['id']) ?>"><i class="fa fa-edit"></i></a>
                 <a class="btn btn-danger btn-sm" href="<?php echo base_url('Proses_produksi/del_fumigasi/'.$key['id']) ?>"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
          <?php $no++;endforeach ?>
        </tbody>
      ...
      <table class="table table-hover hidd">
        <thead class="thead-dark">
          <tr>
            <th>No</th>
            <th>Produk</th>
    ...
    <div class="card-footer">
      <button class="btn btn-primary" onclick="printlayer('kk')"><i class="fa fa-print"></i> Print</button>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url('Proses_produksi/add_fumigasi') ?>">
        <div class="col-lg-12">
...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body" id="print_isi">
      ...
      <center>LAPORAN PROSES PRODUKSI (Fumigasi)<br>
...
<script>
  ...
  function cari(argument) {
    ...
    $.ajax({
      url : '<?php echo base_url("Proses_produksi/cari_fumigasi") ?>',
      method : 'POST',
      ...
      success : function(data){
        ...
        $.ajax({
          url : '<?php echo base_url("Proses_produksi/total_fumigasi") ?>',
          method : 'POST',
          data : {awal:awal, akhir:akhir, produk:produk},
          dataType : 'JSON',
  ...
  $('#ketahui').on('click', function(event) {
    ...
    $.ajax({
      url: '<?php echo base_url('Proses_produksi/drw_fm'); ?>',
      type: 'POST',
      dataType: 'JSON',
