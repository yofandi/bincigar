...
<div class="col-lg-12">
  <div class="card">
    <div class="card-body">
      <strong><i class="fa fa-home"></i> / Dashboard / Proses Produksi / Proses Pressing</strong>
    </div>
  </div>
</div>
<?php 
...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header bg-danger text-light">
      <strong><i class="fa fa-gear"></i> Proses Pressing | Hari Ini : <?php echo date('Y-m-d') ?></strong>
    ...
    <div class="card-body">
      <table class="table table-hover" id="table_ku">
        ...
        <tbody>
          <?php $no=1;foreach ($pressing as $key): ?>
            <tr>
              <td><?php echo $no ?></td>
              ...
              <td>
                <a class="btn btn-warning btn-sm" href="<?php echo base_url('Proses_produksi/edit_pressing/'.$key['id']) ?>"><i class="fa fa-edit"></i></a>
                 <a class="btn btn-danger btn-sm" href="<?php echo base_url('Proses_produksi/del_pressing/'.$key['id']) ?>"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
          <?php $no++;endforeach ?>
        </tbody>
    ...
    <div class="card-footer">
      <a href="<?php echo base_url("Proses_produksi/print_pressing") ?>" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <label><i class="fa fa-gear"></i> Proses Pressing</label>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"></h4>
      </div>
      <div class="modal-body">
        <form method="post" action="<?php echo base_url('Proses_produksi/add_pressing') ?>">
        <div class="col-lg-12">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            ...
            <input type="number" step="any" class="form-control" name="hasil" id="cerutu" value="" readonly>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="form-group">
          <label>Cerutu yang Di tambahkan :</label>
          <input type="number" step="any" name="tambah_cerutu" class="form-control">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="form-group">
...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header bg-danger text-light">
      <b><i class="fa fa-book"></i> Semua Laporan Pressing</b>
    ...
    <div class="card-body" id="print_isi">
      ...
      <center>LAPORAN PROSES PRODUKSI (PRESSING)<br>
...
<script>
  ...
  function cari(argument) {
    ...
    $.ajax({
      url : '<?php echo base_url("Proses_produksi/cari_pressing") ?>',
      method : 'POST',
      ...
      success : function(data){
        ...
        $.ajax({
          url : '<?php echo base_url("Proses_produksi/total_pressing") ?>',
          method : 'POST',
          data : {awal:awal, akhir:akhir, produk:produk},
          dataType : 'JSON',
  ...
  $('#ketahui').on('click', function (event) {
    ...
    $.ajax({
      url: '<?php echo base_url('Proses_produksi/drw_prs'); ?>',
      type: 'POST',
      dataType: 'JSON',
