...
<head>
	...
	<title>Print Proses Frezer</title>
</head>
<style>
...
<img src="<?php echo base_url('assets/images/BIN.png') ?>" style="width: 70px">
	<center>
		<b>LAPORAN PROSES PRODUKSI (FREZER) HARI INI</b>
        ...
        <tfoot>
          <tr>
            ...
            <th>
              <?php echo $this->db->select('SUM(hasil) as hasil')->get('frezer')->row()->hasil; ?>
            </th>
            <th>
              <?php echo $this->db->select('SUM(tambah_cerutu) as tambah_cerutu')->get('frezer')->row()->tambah_cerutu; ?>
            </th>
            <th>
              <?php echo $this->db->select('SUM(hasil_akhir) as hasil_akhir')->get('frezer')->row()->hasil_akhir; ?>
            </th>
