<div class="col-lg-12">
  <div class="card">
    <div class="card-body">
      <strong><i class="fa fa-home"></i> / Dashboard / Proses Produksi / Edit Cool Storage / <?php echo $datas['id'] ?></strong>
    </div>
  </div>
</div>
...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header bg-success text-light">
      <strong><i class="fa fa-edit"></i> Edit Proses Cool Storage</strong>
    </div>
    <div class="card-body">
      
        <form method="post" action="<?php echo base_url('Proses_produksi/update_cool/'.$datas['id']) ?>">
        <div class="col-lg-12">
