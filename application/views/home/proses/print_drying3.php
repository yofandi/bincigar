...
<head>
  <link rel="stylesheet" href="<?php echo base_url('assets/') ?>assets/css/bootstrap.min.css">
	...
	<title>Print Proses Drying 3</title>
</head>
<style>
	...
	<center>
        ...
        <tfoot>
          <tr>
            ...
            <th>
              <?php echo $this->db->select('SUM(hasil) as hasil')->get('drying3')->row()->hasil; ?>
            </th>
            <th>
              <?php echo $this->db->select('SUM(tambah_cerutu) as tambah_cerutu')->get('drying3')->row()->tambah_cerutu; ?>
            </th>
            <th>
              <?php echo $this->db->select('SUM(hasil_akhir) as hasil_akhir')->get('drying3')->row()->hasil_akhir; ?>
            </th>
