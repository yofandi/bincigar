...
<head>
	...
	<title>Print Proses Cool Storage</title>
</head>
<style>
...
<?php $setting = $this->db->get_where('setting', array('id' => 1))->row_array(); ?>
  <img src="<?php echo base_url('assets/images/BIN.png') ?>" style="width: 70px">
	<center>
		<b>LAPORAN PROSES PRODUKSI (COOL STORAGE) HARI INI</b>
        ...
        <tfoot>
          <tr>
            ...
            <th>
              <?php echo $this->db->select('SUM(hasil) as hasil')->get('cool')->row()->hasil; ?>
            </th>
            <th>
              <?php echo $this->db->select('SUM(tambah_cerutu) as tambah_cerutu')->get('cool')->row()->tambah_cerutu; ?>
            </th>
            <th>
              <?php echo $this->db->select('SUM(hasil_akhir) as hasil_akhir')->get('cool')->row()->hasil_akhir; ?>
            </th>
