		...
		<div class="card-body">
			...
			<div class="col-lg-12">
				...
				<div class="form-group">
					...
					<input type="text" name="cerah_hujan" id="cerah_hujan" class="form-control" required="">
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
			...
			<div class="col-lg-4">
				<div class="form-group">
					<label>Siang : </label>
					<input type="text" name="siang" id="siang" class="form-control" required="">
					<small>28C-  70%</small>
				</div>
			</div>
			<div class="col-lg-4">
			...
			<div class="col-lg-4">
				<div class="form-group">
					<label>Bak Air : </label>
					<textarea class="form-control" name="bak_air" id="bak_air" rows="5" required=""></textarea>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
					<label>Lasiotrap Di Ruangan : </label>
					<textarea class="form-control" name="lasiotrap_ruangan" id="lasiotrap_ruangan" rows="5"></textarea>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
					<label>Lasiotrap Di Lemari : </label>
					<textarea class="form-control" name="lasiotrap_lemari" id="lasiotrap_lemari" rows="5"></textarea>
				</div>
			</div>
			<div class="col-lg-12">
			...
			<div class="col-lg-4">
				<div class="form-group">
					<label>DS : </label>
					<input type="number" name="ds" id="ds" class="form-control" required=""> 
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
					<label>Store : </label>
					<input type="number" name="store" id="store" class="form-control" required=""> 
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
					<label>Agent : </label>
					<input type="number" name="agent" id="agent" class="form-control" required=""> 
				</div>
			</div>
			<div class="col-lg-12">
				<b>*4. Laporan DS*</b>
			...
			<div class="col-lg-4">
				<div class="form-group">
					<label>Call : </label>
					<input type="text" name="call" id="call" class="form-control" required=""> 
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
					<label>Efektif Call : </label>
					<input type="text" name="efektif_call" id="efektif_call" class="form-control" required=""> 
				</div>
			</div>
			<div class="col-lg-4">
				<div class="form-group">
					<label>No : </label>
					<input type="text" name="noo" id="noo" class="form-control" required=""> 
				</div>
			</div>
			<div class="col-lg-12">
				<div class="form-group">
					<b>*5. Catatan Direksi*</b>
					<textarea class="form-control" id="direksi"></textarea>
				</div>
			</div>
			<div class="col-lg-12">
				<div class="form-group">
					<b>*6. Kesulitan*</b>
					<textarea class="form-control" id="kesulitan"></textarea>
				</div>
			</div>
		</div>
...
<script>
	...
	$('#simpan').on('click', function(event){
		...
		$.ajax({
			url : '<?php echo base_url("Home/simpan_laporan") ?>',
			method : 'POST',
			data : {
	...
	$(document).ready(function(){
		// $('#direksi').froalaEditor();
		// $('#kesulitan').froalaEditor();
