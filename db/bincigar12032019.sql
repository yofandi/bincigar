...
--
-- Host: localhost
-- Generation Time: Mar 12, 2019 at 04:04 AM
...
(13, 'HK56', 'OPL', '5.00', '4.00', '1.00', 300, 250, 50, '', '2019-03-01', 'bin cigar');
...
(11, 'HK56', 'OPL', 90, 90, 0, '3 jam', '', '2019-03-01', 0);
...
(25, '2019-03-01', 'Beli Exsternal', 'OPL', 'FILLER 1', '12.00', '12.00', '5.00', '7.00', '', 'bin cigar'),
(26, '2019-03-01', 'Tanam Sendiri', 'OPL', 'OMBLAD', '12.00', '12.00', '5.00', '7.00', '', 'bin cigar'),
(27, '2019-03-01', 'Tanam Sendiri', 'OPL', 'DEKBLAD', '12.00', '12.00', '5.00', '7.00', '', 'bin cigar');
...
(11, 'HK56', 'OPL', 195, 90, 105, '1 jam', '', '2019-03-01', 'bin cigar');
...
(11, 'HK56', 'OPL', 90, 90, 0, '3 jam', '', '2019-03-01', 'bin cigar');
...
(11, 'HK56', 'OPL', 90, 80, 10, '3 jam', '', '2019-03-01', 'bin cigar');
...
(11, 'HK56', 'OPL', '5.00', '4.00', '1.00', 300, '2019-03-01', 'bin cigar');
...
(11, 'HK56', 'OPL', 90, 90, 0, '3 jam', '2019-03-01', 'qw', 'bin cigar');
...
(11, 'HK56', 'OPL', 250, 200, 50, '3 jam', 'wqwe', '2019-03-01', 'bin cigar');
...
(17, 'HK56', 'OPL', 80, 80, 0, 0, 0, '', '2019-03-01', 'bin cigar');
...
(20, 17, 0, 5, 0, 5, '', 'HK56', 'HJ Prima', 'Wooden', 10, 80, 50, 30, 'bin cigar', '2019-03-01');
...
(11, 'HK56', 'OPL', '5.00', '4.00', '1.00', 200, 195, 5, '', '2019-03-01', 'bin cigar');
...
--
ALTER TABLE `binding_tmp`
  MODIFY `id_bind` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `cool_tmp`
  MODIFY `id_cool` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `drying2_tmp`
  MODIFY `id_dry2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `drying3_tmp`
  MODIFY `id_dry3` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `drying_tmp`
--
ALTER TABLE `drying_tmp`
  MODIFY `id_dry` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `filling_tmp`
  MODIFY `id_fill` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `frezer_tmp`
  MODIFY `id_frez` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `fumigasi_tmp`
  MODIFY `id_fumi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `qual_con_tmp`
  MODIFY `id_q` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `wrapping_tmp`
  MODIFY `id_wrap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
