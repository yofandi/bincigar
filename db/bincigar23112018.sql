...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2018 at 10:44 AM
...
(11, 1245000, 5, 'Cash', 50000, 1232750, 1232750, 1, 'AGENT', '2018-10-04', 'admins', 5, '', '', '0000-00-00', '', '', '', 'mantap', '2018-10-04 08:11:49'),
(12, 330000, 5, 'Cash', 10000, 3235000, 3235000, 1, 'STORE', '2018-10-04', 'admins', 4, '', '', '0000-00-00', '', '', '', 'ads', '2018-10-04 09:01:38'),
(13, 165000, 0, 'Transfer', 0, 165000, 165000, 1, 'STORE', '2018-10-04', 'admins', 1, '', '', '0000-00-00', '', '', '', 'asasasasasasasa', '2018-10-04 10:18:44'),
(14, 330000, 5, 'Transfer', 10000, 323500, 323500, 1, 'AGENT', '2018-10-04', 'admins', 3, '', '', '0000-00-00', '', '', '', 'addda', '2018-10-04 10:26:15'),
(15, 330000, 5, 'Transfer', 30000, 343500, 343500, 1, 'AGENT', '2018-10-04', 'admins', 3, '', '', '0000-00-00', '', '', '', 'asads', '2018-10-04 10:27:55'),
(16, 415000, 10, 'Cash', 10000, 383500, 283500, 1, 'AGENT', '2018-10-07', 'admins', 5, '', '', '0000-00-00', '', '', '', 'cak ko', '2018-10-07 11:07:56'),
(17, 540000, 10, 'Cash', 5000, 491000, 491000, 9, 'AGENT', '2018-10-07', 'amora', 3, '', '', '0000-00-00', '', '', '', 'sip', '2018-10-07 18:45:24'),
(19, 540000, 0, 'Cash', 30000, 570000, 570000, 9, 'AGENT', '2018-10-07', 'amora', 0, '', '', '0000-00-00', '', '', '', 'ajib bangetlah', '2018-10-07 19:11:29'),
(20, 540000, 5, 'Cash', 15000, 528000, 528000, 9, 'AGENT', '2018-10-07', 'amora', 0, '', '', '0000-00-00', '', '', '', 'aaads', '2018-10-07 19:20:59'),
(21, 540000, 0, 'Cash', 12000, 552000, 552000, 9, 'AGENT', '2018-10-07', 'amora', 3, '', '', '0000-00-00', '', '', '', 'asaaaaa', '2018-10-07 19:22:10'),
(22, 800000, 0, 'Cash', 50000, 850000, 850000, 11, 'PHRI', '2018-10-08', 'karin', 6, '', '', '0000-00-00', '', '', '', 'dsds', '2018-10-08 03:16:39'),
...
--
ALTER TABLE `binding_tmp`
  MODIFY `id_bind` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `cerutu_terjual`
--
ALTER TABLE `cerutu_terjual`
  MODIFY `id_cr_terjual` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `cool_tmp`
  MODIFY `id_cool` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `data_produksi`
  MODIFY `id_pr` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `drying2_tmp`
  MODIFY `id_dry2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `drying3_tmp`
  MODIFY `id_dry3` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `drying_tmp`
--
ALTER TABLE `drying_tmp`
  MODIFY `id_dry` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `filling_tmp`
  MODIFY `id_fill` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `frezer_tmp`
  MODIFY `id_frez` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `fumigasi_tmp`
  MODIFY `id_fumi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `penjualan_cerutu`
  MODIFY `id_penjualan_bagan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `pressing_tmp`
  MODIFY `id_pres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `qual_con_tmp`
  MODIFY `id_q` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `stock_awalrekap`
  MODIFY `id_strekap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `stock_bagan`
--
ALTER TABLE `stock_bagan`
  MODIFY `id_stock_bagan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `wrapping_tmp`
  MODIFY `id_wrap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
