...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2018 at 11:08 AM
...
INSERT INTO `cerutu_terjual` (`id_cr_terjual`, `id_penjualan_bagan`, `id_subproduk`, `jml`, `total`, `tanggal`) VALUES
(1, 11, 1, 2, 1080000, '2018-10-04'),
(2, 11, 3, 1, 165000, '2018-10-04'),
(3, 12, 3, 2, 330000, '2018-10-04'),
(4, 13, 3, 1, 165000, '2018-10-04'),
(5, 14, 3, 2, 330000, '2018-10-04'),
(6, 15, 3, 2, 330000, '2018-10-04'),
(7, 16, 3, 1, 165000, '2018-10-07'),
(8, 16, 8, 1, 250000, '2018-10-07'),
(9, 17, 1, 1, 540000, '2018-10-07'),
(11, 19, 1, 1, 540000, '2018-10-07'),
(12, 20, 1, 1, 540000, '2018-10-07'),
(13, 21, 1, 1, 540000, '2018-10-07'),
(14, 22, 6, 1, 800000, '2018-10-08');
...
(10, 'TS', 'DEKBLAD', '90.50'),
(12, 'TC', 'FILLER 2', '2.50'),
(13, 'VIRGINIA', 'FILLER 1', '87.10'),
(14, 'VIRGINIA', 'OMBLAD', '87.58'),
(15, 'VIRGINIA', 'DEKBLAD', '87.37');
...
(4, '17', '18', '27', '24', 'kk', 'll', 'pp', '9', '6', '10', 'p', 'm', 'k', '<p>keren1</p>', '<p>sulit sam</p>', '2018-08-14', 'admins', 0),
(5, '90', '17', '30', '24', 'sd', 'smp', 'smk', '10', '4', '14', 'cs', 'ds', 'vd', '<p>mantap</p>', '<p>kerenlah</p>', '2018-08-14', 'admins', 0),
(6, '12', '22', '28', '2', '12', '23', '34', '12', '23', '234', '23', '44', '53', '<p>fd</p>', '<p>df</p>', '2018-08-30', 'admins', 0),
(7, 'sasa', 'as', 'as', 'sa', 'sa', 'as', 'as', '23', '12', '2', 'ew', '21', '12', '<p>aew</p>', '<p>asa</p>', '2018-09-04', 'admins', 0);
...
INSERT INTO `penjualan_cerutu` (`id_penjualan_bagan`, `harga_semua_cerutu`, `diskon`, `sistem`, `ongkos`, `total`, `yang_dibayar`, `id_users`, `bagan`, `tanggal`, `author`, `customer`, `keterangan`, `created_at`) VALUES
(11, 1245000, 5, 'Cash', 50000, 1232750, 1232750, 1, 'AGENT', '2018-10-04', 'admins', 5, 'mantap', '2018-10-04 08:11:49'),
(12, 330000, 5, 'Cash', 10000, 3235000, 3235000, 1, 'STORE', '2018-10-04', 'admins', 4, 'ads', '2018-10-04 09:01:38'),
(13, 165000, 0, 'Transfer', 0, 165000, 165000, 1, 'STORE', '2018-10-04', 'admins', 1, 'asasasasasasasa', '2018-10-04 10:18:44'),
(14, 330000, 5, 'Transfer', 10000, 323500, 323500, 1, 'AGENT', '2018-10-04', 'admins', 3, 'addda', '2018-10-04 10:26:15'),
(15, 330000, 5, 'Transfer', 30000, 343500, 343500, 1, 'AGENT', '2018-10-04', 'admins', 3, 'asads', '2018-10-04 10:27:55'),
(16, 415000, 10, 'Cash', 10000, 383500, 283500, 1, 'AGENT', '2018-10-07', 'admins', 5, 'cak ko', '2018-10-07 11:07:56'),
(17, 540000, 10, 'Cash', 5000, 491000, 491000, 9, 'AGENT', '2018-10-07', 'amora', 3, 'sip', '2018-10-07 18:45:24'),
(19, 540000, 0, 'Cash', 30000, 570000, 570000, 9, 'AGENT', '2018-10-07', 'amora', 0, 'ajib bangetlah', '2018-10-07 19:11:29'),
(20, 540000, 5, 'Cash', 15000, 528000, 528000, 9, 'AGENT', '2018-10-07', 'amora', 0, 'aaads', '2018-10-07 19:20:59'),
(21, 540000, 0, 'Cash', 12000, 552000, 552000, 9, 'AGENT', '2018-10-07', 'amora', 3, 'asaaaaa', '2018-10-07 19:22:10'),
(22, 800000, 0, 'Cash', 50000, 850000, 850000, 11, 'PHRI', '2018-10-08', 'karin', 6, 'dsds', '2018-10-08 03:16:39');
...
(1, 8, 'Robusto', 'BR10', 'Robusto', 95),
(2, 9, 'Robusto', 'BR3', 'Robusto', 150),
(3, 13, 'Corona', 'BC10', 'Corona', 117),
(4, 14, 'Corona', 'BC5', 'Corona', 44),
(5, 15, 'Corona', 'BC1F', 'Corona', 58);
...
(2, 'Robusto', 29, 100, 129),
(3, 'Corona', 500, 500, 1000),
(4, 'Corona', 300, 300, 600),
(5, 'Siglo VI', 300, 300, 600);
...
--
ALTER TABLE `binding_tmp`
  MODIFY `id_bind` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `cerutu_terjual`
--
ALTER TABLE `cerutu_terjual`
  MODIFY `id_cr_terjual` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `cool_tmp`
  MODIFY `id_cool` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `data_produksi`
  MODIFY `id_pr` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `drying2_tmp`
  MODIFY `id_dry2` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `drying3_tmp`
  MODIFY `id_dry3` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `drying_tmp`
--
ALTER TABLE `drying_tmp`
  MODIFY `id_dry` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `filling_tmp`
  MODIFY `id_fill` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `frezer_tmp`
  MODIFY `id_frez` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `fumigasi_tmp`
  MODIFY `id_fumi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `penjualan_cerutu`
  MODIFY `id_penjualan_bagan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `piutang`
  MODIFY `id_piutang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `pressing_tmp`
  MODIFY `id_pres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `stock_awalrekap`
  MODIFY `id_strekap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `stock_bagan`
--
ALTER TABLE `stock_bagan`
  MODIFY `id_stock_bagan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `wrapping_tmp`
  MODIFY `id_wrap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
